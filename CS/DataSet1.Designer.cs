...
namespace RichEditDataBoundScenario {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class CarsDataTable : global::System.Data.DataTable, global::System.Collections.IEnumerable {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public CarsRow AddCarsRow(string Model, string RtfContent) {
            ...
            private void InitClass() {
                ...
                this.columnRtfContent.MaxLength = 2147483647;
            }
...
namespace RichEditDataBoundScenario.DataSet1TableAdapters {
    ...
    public partial class CarsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Cars] WHERE (([ID] = @Original_ID) AND ((@IsNull_Model = 1 AND" +
                " [Model] IS NULL) OR ([Model] = @Original_Model)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Cars] ([Model], [RtfContent]) VALUES (@Model, @RtfContent);\r\nS" +
                "ELECT ID, Model, RtfContent FROM Cars WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@RtfContent", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "RtfContent", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Cars] SET [Model] = @Model, [RtfContent] = @RtfContent WHERE (([ID]" +
                " = @Original_ID) AND ((@IsNull_Model = 1 AND [Model] IS NULL) OR ([Model] = @Ori" +
                "ginal_Model)));\r\nSELECT ID, Model, RtfContent FROM Cars WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@RtfContent", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "RtfContent", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::RichEditDataBoundScenario.Properties.Settings.Default.CarsDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Model, RtfContent FROM dbo.Cars";
        ...
        public virtual int Insert(string Model, string RtfContent) {
            if ((Model == null)) {
            ...
            if ((RtfContent == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[1].Value = ((string)(RtfContent));
            }
        ...
        public virtual int Update(string Model, string RtfContent, int Original_ID, string Original_Model, int ID) {
            if ((Model == null)) {
            ...
            if ((RtfContent == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[1].Value = ((string)(RtfContent));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Model, string RtfContent, int Original_ID, string Original_Model) {
            return this.Update(Model, RtfContent, Original_ID, Original_Model, Original_ID);
        }
    }
