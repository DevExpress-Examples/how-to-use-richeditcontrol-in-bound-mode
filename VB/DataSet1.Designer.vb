	...
	Partial Public Class DataSet1
		...
		Partial Public Class CarsDataTable
			...
			Public Function AddCarsRow(ByVal Model As String, ByVal RtfContent As String) As CarsRow
				...
				Dim columnValuesArray() As Object = { Nothing, Model, RtfContent}
...
Namespace RichEditDataBoundScenario.DataSet1TableAdapters
	...
	Partial Public Class CarsTableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Cars] ([Model], [RtfContent]) VALUES (@Model, @RtfContent);" & Constants.vbCrLf & "S" & "ELECT ID, Model, RtfContent FROM Cars WHERE (ID = SCOPE_IDENTITY())"
			...
			Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Cars] SET [Model] = @Model, [RtfContent] = @RtfContent WHERE (([ID]" & " = @Original_ID) AND ((@IsNull_Model = 1 AND [Model] IS NULL) OR ([Model] = @Ori" & "ginal_Model)));" & Constants.vbCrLf & "SELECT ID, Model, RtfContent FROM Cars WHERE (ID = @ID)"
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT ID, Model, RtfContent FROM dbo.Cars"
		...
		Public Overridable Function Fill(ByVal dataTable As DataSet1.CarsDataTable) As Integer
		...
		Public Overridable Function GetData() As DataSet1.CarsDataTable
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			Dim dataTable As New DataSet1.CarsDataTable()
		...
		Public Overridable Function Update(ByVal dataTable As DataSet1.CarsDataTable) As Integer
		...
		Public Overridable Function Insert(ByVal Model As String, ByVal RtfContent As String) As Integer
			...
			Else
				Me.Adapter.InsertCommand.Parameters(1).Value = (CStr(RtfContent))
			End If
		...
		Public Overridable Function Update(ByVal Model As String, ByVal RtfContent As String, ByVal Original_ID As Integer, ByVal Original_Model As String, ByVal ID As Integer) As Integer
			...
			Else
				Me.Adapter.UpdateCommand.Parameters(1).Value = (CStr(RtfContent))
			End If
