...
Namespace RichEditDataBoundScenario.DataSet1TableAdapters
    ...
    Public Partial Class CarsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Cars] ([Model], [RtfContent]) VALUES (@Model, @RtfContent);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "S" & "ELECT ID, Model, RtfContent FROM Cars WHERE (ID = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Cars] SET [Model] = @Model, [RtfContent] = @RtfContent WHERE (([ID]" & " = @Original_ID) AND ((@IsNull_Model = 1 AND [Model] IS NULL) OR ([Model] = @Ori" & "ginal_Model)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT ID, Model, RtfContent FROM Cars WHERE (ID = @ID)"
